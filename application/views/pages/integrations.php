                ...
                <div class="col-sm-6 mb-4">
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            <div class="mb-3 integration-info">
                                <small>
                                    <?= lang('migrations_info') ?>
                                </small>
                            </div>
                        </div>
                        <div class="card-footer bg-white border-0">
                            <button type="button" id="run-migrations" class="btn btn-outline-primary w-100">
...
<script src="<?= asset_url('assets/js/pages/integrations.js') ?>"></script>
